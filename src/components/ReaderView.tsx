...
export function ReaderView({
  ...
  return (
    <div className="reader-scrim" onClick={onClose}>
      <div className="reader-shell" onClick={(e) => e.stopPropagation()} role="dialog" aria-label="Reader view">
        <div className="reader-bar">
          ...
          <div className="row gap6">
            ...
            <button className="btn icon sm" onClick={onClose} aria-label="Close reader"><I n="ph-x" /></button>
          </div>
        </div>
